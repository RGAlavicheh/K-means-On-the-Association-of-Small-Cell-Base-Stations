...
function [probOFasso,average_num,avg_sum_rate,avg_SCBSs_number,avg_bw_consumption] =func_s2_without_BWconstraint(iter,L,W,power,X,h,C,cluster)
...
UAVs_number = cluster; % equal cluster number if kmeans used
